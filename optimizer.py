...
class OptimizerAdam:
    ...
    def pre_update_params(self):
        if self.decay:
            self.current_learning_rate = self.learning_rate * (1. / (1. + self.decay * self.iterations))  # Lowers the learning rate before each update
    ...
    # Call once after any parameter updates
    def post_update_params(self):
        self.iterations += 1  # Counts every update made to adjust the rate correctly
